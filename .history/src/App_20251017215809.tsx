  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      <Section 
        ...
        imgSrc={`${import.meta.env.BASE_URL}sigiriya-sunrise.jpg`} 
      ...
      <Section 
        ...
        imgSrc={`${import.meta.env.BASE_URL}Temp_167a9419-5390-4733-9a68-4b2c5ff7f365.png`} 
      ...
      <Section 
        ...
        imgSrc={`${import.meta.env.BASE_URL}SAMBAR-DEER-IN-HORTON-PLAINS-NATIONAL-PARK-copy.jpg`} 
      ...
      <Section 
        ...
        imgSrc={`${import.meta.env.BASE_URL}Galle-1024x768.jpg`} 
