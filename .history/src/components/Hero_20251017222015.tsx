...
export const Hero = () => {
  ...
  return <div className="relative w-full min-h-[80vh] md:h-screen">
      ...
      <div className="absolute bottom-6 md:bottom-8 left-0 right-0 flex justify-center">
        <div className="animate-bounce bg-white p-2 w-9 h-9 md:w-10 md:h-10 ring-1 ring-slate-200 shadow-lg rounded-full flex items-center justify-center">
